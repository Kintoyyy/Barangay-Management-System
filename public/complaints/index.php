                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body complaint-form">
                            <form method="post"
                                ...
                                <input type="hidden"
                                    name="complaint_id"
                                    value="<?= htmlspecialchars( $editComplaint[ 'complaint_id' ] ?? '' ) ?>">

                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="resident_id"
                                                class="form-label">Complainant Resident *</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="resolved_by"
                                                class="form-label">Resolved By (Official)</label>
                                ...
                                <div class="form-group">
                                    <label for="resolution_notes"
                                        class="form-label">Resolution Notes</label>
                                ...
                                <div class="d-flex justify-content-between mt-4">
                                    ...
                                    <button type="submit"
                                        class="btn btn-primary btn-lg">Save Complaint</button>
                                </div>
                            </form>
                        </div>
                    </div>
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <?php else: ?>
                                        <tr>
                                            <td colspan="7"
                                                class="text-center py-4">No complaints found</td>
                                        </tr>
                                    <?php endif; ?>
                                </tbody>
                            </table>
